    ...
    <div class="card-body">
        <div class="widget-card-inner">
            <div class="widget-card bg--success">
                <a href="{{ url()->route('admin.payment.successful', request()->all()) }}" class="widget-card-link"></a>
            ...
            <div class="widget-card bg--warning">
                <a href="{{ url()->route('admin.payment.pending', request()->all()) }}" class="widget-card-link"></a>
                <div class="widget-card-left">
                    <div class="widget-card-icon">
            ...
            <div class="widget-card bg--danger">
                <a href="{{ url()->route('admin.payment.rejected', request()->all()) }}" class="widget-card-link"></a>
                <div class="widget-card-left">
                    <div class="widget-card-icon">
            ...
            <div class="widget-card bg--dark">
                <a href="{{ url()->route('admin.payment.initiated', request()->all()) }}" class="widget-card-link"></a>
                <div class="widget-card-left">
                    <div class="widget-card-icon">
