                        ...
                        <ul class="list-group">
                            ...
                            <li class="list-group-item d-flex flex-wrap flex-sm-nowrap gap-2 justify-content-between align-items-center">
                                <div>
                                    ...
                                    <p class="mb-0">
                                        <small>@lang('If you enable this module, any user can invite people to use the system, The referrers will get commission as per') <a href="{{ route('admin.setting.referral') }}">@lang('commission setting')</a></small>
                                    </p>
                                </div>
                                <div class="form-group">
