...
@section('content')
    ...
    @else
        ...
        <div class="text-center">
            ...
            <h6 class="mt-3 mb-0">@lang('You have no wallet yet. At first, you have to purchase our mining plans. You can purchase our plan from') <a class="text--base" href="{{ route('plans') }}">@lang('here.')</a></h6>
        </div>
    @endif
